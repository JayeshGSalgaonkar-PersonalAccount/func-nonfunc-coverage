...
#    And print response.content.education_level
    * def kittens = get expectedEducationLevelResponse.content.education_level[*].code
    * def mittens = get expectedEducationLevelResponse.content.education_level[*].value
    Then match kittens == expectedCode
    Then match mittens == expectedValue
    And print mittens
