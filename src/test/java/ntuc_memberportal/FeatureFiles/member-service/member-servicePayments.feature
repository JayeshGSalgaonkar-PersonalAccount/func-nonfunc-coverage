...
#----------------------------------------------------------------------------------------------------------------
#   GET - XX Payment creation as pre-requisite (SUJIT to take necessary actions)
...
#----------------------------------------------------------------------------------------------------------------
#   GET - Payment creation as pre-requisite (SUJIT to take necessary actions)
...
##   GET Need to revalidate API Call (SUJIT to take necessary actions)
