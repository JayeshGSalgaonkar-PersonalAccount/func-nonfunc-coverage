...
#-----------------------------------------------------------------------------------------------------------------------
# GET - Before hitting DRAFT request, need Draft creation step (SUJIT to take necessary actions)
...
#--------------------------------------------------------------------------------------------------------------
#   Patch - XX Before hitting API, satisfy "create membership" prerequsitie  (SUJIT to take necessary actions)
...
#--------------------------------------------------------------------------------------------------------------
#   PUT API calls needs to be re-validated (SUJIT to take necessary actions)
...
#--------------------------------------------------------------------------------------------------------------
#   POST - XX API calls needs to be re-validated (SUJIT to take necessary actions)
...
#--------------------------------------------------------------------------------------------------------------
#   POST -1 API calls needs to be re-validated (SUJIT to take necessary actions)
